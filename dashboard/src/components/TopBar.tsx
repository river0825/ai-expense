...
export function TopBar() {
  ...
  return (
    <header className="fixed top-0 right-0 left-64 h-20 glass-panel border-b border-white/10 z-40 px-8 flex items-center justify-between">
      {/* Search */}
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="flex items-center gap-3 pl-2 pr-1 rounded-lg hover:bg-white/5 transition-colors group">
          ...
          <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-primary to-cta p-[2px]">
          ...
          <ChevronDownIcon className="w-4 h-4 text-text/40 group-hover:text-text transition-colors" />
        </button>
      </div>
    </header>
  );
